...
<header id="main-header" class="fixed top-0 left-0 w-full z-40 bg-transparent transition-colors duration-300">
    <nav aria-label="Global" class="mx-auto flex max-w-8xl items-center justify-between p-6 lg:px-8">
        <div class="flex lg:flex-1">
            <a href="{{ route('home') }}" class="-m-1.5">
                <span class="sr-only">Your Company</span>
                <img src="{{ asset(config('app.asset_client_path') . '/image/logo.png') }}" alt=""
                    class="h-[40px] w-auto" />
            </a>
        </div>
        ...
        <el-popover-group class="hidden lg:flex lg:gap-x-12">
            <a href="#" class="text-sm/6 font-semibold text-white">Chủ Đề</a>
            <div class="relative">
                <button popovertarget="desktop-menu-category"
                ...
                <el-popover id="desktop-menu-category" anchor="bottom" popover
            ...
            <a href="#" class="text-sm/6 font-semibold text-white">Phim Lẻ</a>
            <a href="#" class="text-sm/6 font-semibold text-white">Phim Bộ</a>
            <div class="relative">
                <button popovertarget="desktop-menu-country"
                    class="flex items-center gap-x-1 text-sm/6 font-semibold text-white">
                    Quốc Gia
                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true"
                        class="size-5 flex-none text-gray-500">
                ...
                <el-popover id="desktop-menu-country" anchor="bottom" popover
                    class="w-screen max-w-md overflow-hidden rounded-3xl bg-gray-800 outline-1 -outline-offset-1 outline-white/10 transition transition-discrete [--anchor-gap:--spacing(3)] backdrop:bg-transparent open:block data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in">
                    <div class="p-4">
                        <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-white/5">
                            <div
            ...
            <a href="#" class="text-sm/6 font-semibold text-white">Xem Chung</a>
        </el-popover-group>
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="{{ route('login') }}"
                class="text-sm/6 font-semibold text-white flex items-center gap-1 px-3 py-1 rounded-lg
              transition duration-300 hover:bg-white hover:text-black hover:rounded-lg">
                ...
                <el-dialog-panel
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-white/10">
                            ...
                            <div class="py-6">
                                <a href="{{ route('login') }}"
                                    class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-white/5">Thành
                                    Viên</a>
                            </div>
                        </div>
                    </div>
