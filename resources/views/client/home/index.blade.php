...
<div class="container-xxl mx-auto px-4">
    <div class="w-full max-w-8xl mx-auto">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <!-- Topic Item -->
            <a href="/c/marvel-sieu-anh-hung.vhyYAW"
                class="relative aspect-[16/9] rounded-xl overflow-hidden group transform transition duration-300 hover:-translate-y-2 hover:scale-105 shadow-md hover:shadow-xl">
            ...
            <a href="/c/sitcom-series-us.SosVge"
                class="relative aspect-[16/9] rounded-xl overflow-hidden group transform transition duration-300 hover:-translate-y-2 hover:scale-105 shadow-md hover:shadow-xl">
            ...
            <a href="/c/long-tieng-cuc-manh.PGxRUU"
                class="relative aspect-[16/9] rounded-xl overflow-hidden group transform transition duration-300 hover:-translate-y-2 hover:scale-105 shadow-md hover:shadow-xl">
            ...
            <!-- More Topics -->
            <a href="/chu-de"
                class="relative aspect-[16/9] rounded-xl overflow-hidden flex items-center justify-center p-4 bg-[#2e3245] text-white text-lg font-medium transform transition duration-300 hover:-translate-y-2 hover:scale-105 shadow-md hover:shadow-xl">
                +4 chủ đề
            </a>
        </div>
    </div>
    ...
    <div class="movie-section mt-10">
        <div class="flex flex-col lg:flex-row lg:items-start gap-6 w-full">
            ...
            <div class="flex flex-col lg:w-[248px]">
                ...
                <a href="/c/phim-han-quoc-moi.3KYr2v"
                    class="flex items-center mt-2 gap-1 text-sm text-gray-300 hover:text-white transition">
            ...
            <div class="relative w-full mx-auto">
                <!-- Nút Prev -->
                <button id="prevBtn"
                    class="absolute left-2 top-1/2 -translate-y-1/2 z-20 flex items-center justify-center w-12 h-12 rounded-full bg-black/40 hover:bg-black/70 transition">
                ...
                <div id="slider" class="flex overflow-x-hidden transition-transform duration-500">
                    ...
                    <div class="flex-none w-1/5 p-2">
                        <div class="bg-gray-800 rounded-xl overflow-hidden shadow relative group">
                            <!-- Ảnh -->
                            <img src="https://phunuso.mediacdn.vn/603486343963435008/2025/1/23/1-1737603674770526871157.jpg"
            ...
            opacity-0 group-hover:opacity-100 transition">
                                <button
                                    class="w-12 h-12 md:w-14 md:h-14 flex items-center justify-center bg-red-600 hover:bg-red-700 rounded-full shadow-lg transition transform hover:scale-105">
                ...
                <!-- Nút Next -->
                <button id="nextBtn"
                    class="absolute right-2 top-1/2 -translate-y-1/2 z-20 flex items-center justify-center w-12 h-12 rounded-full bg-black/40 hover:bg-black/70 transition">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
